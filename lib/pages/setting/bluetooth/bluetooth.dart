                    ...
                    Expanded(
                      child: DropdownButton(
                        ...
                        onChanged: (BluetoothDevice value) async {
                          ...
                          await Session()
                              .set('bluetooth_device', value.address);
                          await Session()
                              .set('bluettoth_device_name', value.name);
                        },
                        value: _device,
                      ),
                    ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        _connected ? 'Disconnect' : 'Set Default',
                        style: TextStyle(color: Colors.white),
                      ),
                    ),
                  ],
  ...
  void _connect() async {
    if (_device != null) {
      bluetooth.isConnected.then((isConnected) async {
        ...
        await Session().set('bluetooth_device', _device.address);
        await Session().set('bluettoth_device_name', _device.name);
