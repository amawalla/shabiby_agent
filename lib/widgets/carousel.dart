...
class Carousel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<Bluetooth>(builder: (context, child, model) {
  ...
  Widget _buildCarouselTitle(
    ...
    var title = scanResults.length == 1
        ? "Found Hexoskin device"
        : "Found Hexoskin devices";
    return Text(title,
  ...
  Widget _buildCarouselItem(
    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        ScopedModelDescendant<Bluetooth>(builder: (context, child, model) {
          return InkWell(
            onTap: () {
